...
@app.get("/api/providers/openai-codex/oauth/status", response_model=OpenAIOAuthStatusResponse)
...
@app.get("/api/providers/openai-codex/oauth/models", response_model=OpenAIOAuthModelsResponse)
...
@app.get("/api/providers/openai-codex/oauth/start", response_class=HTMLResponse)
...
@app.get("/api/providers/openai-codex/oauth/callback", response_class=HTMLResponse, name="openai_oauth_callback")
...
@app.post("/api/providers/openai-codex/oauth/complete", response_model=OpenAIOAuthStatusResponse)
...
@app.post("/api/providers/openai-codex/oauth/disconnect", response_model=OpenAIOAuthStatusResponse)
